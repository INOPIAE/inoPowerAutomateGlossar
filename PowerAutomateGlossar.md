...
| Icon | Englisch | Deutsch | Kommentar | Englischer Hinweis |
| --- | --- | --- | --- | --- |
...
|  | Send an email (V2) | E-Mail senden (V2) |  |   |
|  | When a new email arrives (V3) | Bei Eingang einer neuen E-Mail | Trigger |   |
|  | When an email is flagged (V3) | Bei Kennzeichnen einer E-Mail (V3) | Trigger |   |
|  | When an email is flagged (V4) | Wenn eine E-Mail gekennzeichnet ist (V4) |  Preview, Trigger |   |
|  | Delete contact (V2) | Kontakt löschen (V2) |  |   |
|  | Delete email (V2) | E-Mail löschen (V2) |  |   |
|  | Delete event (V2)  | Ereignis löschen (V2) |  |   |
|  | Export email (V2) | E-Mail exportieren (V2) |  |   |
|  | Find meeting times (V2) | Besprechungstermine suchen (V2) |  |   |
|  | Flag email (V2) | E-Mail kennzeichnen (V2) |  |   |
|  | Forward an email (V2) | E-Mail weiterleiten (V2) |  |   |
|  | Get Attachment (V2) | Anlage abrufen (V2) |  |   |
|  | Get calendars (V2) | Kalender abrufen (V2) |  |   |
|  | Get contact (V2) | Kontakt abrufen (V2) |  |   |
|  | Get contact folder (V2) | Kontaktordener abrufen (V2) |  |   |
|  | Get contacts (V2) | Kontakte abrufen (V2)  |  |   |
|  | Get email (V2) | E-Mail abrufen (V2) |  |   |
|  | Get emails (V3) | E-Mails abrufen (V3)|  |   |
|  | Get event (V3) | Termin abrufen (V3) |  |   |
|  | Get events (V4) | Termine abrufen (V4) |  |   |
|  | Get mail tips for a mailbox (V2) | E-Mail-Infos für ein Postfach abrufen (2) |  |   |
|  | Get room list (V2) | Raumlisten abrufen (V2) |  |   |
|  | Get rooms (V2) | Räume abrufen (V2) |  |   |
|  | Get rooms in room list (V2) | Räume in Raumliste abrufen (V2) |  |   |
|  | Mark as read or unread (V2) | Als gelesen oder ungekesen markieren (V2) |  |   |
|  | Move email (V2) | E-Mail verschieben |  |   |
|  | Reply to email (V3) | Auf E-Mail antworten (V2) |  |   |
|  | Respond to an event invite (V2) | Auf Ereigniseinladung antworten (V2) |  |   |
|  | Send email from a shared mailbox (V2) | E-Mail aus freigegebenen Postfach senden (V2) |  |   |
|  | Send email with options | E-Mail mit Optionen senden |  |   |
